      ...
      <div className="flex items-center justify-center gap-6 px-4 py-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm font-semibold text-text-primary font-mono">
            {isFiltered
              ? `${filteredPiezo.toLocaleString('fr-FR')} / ${totalPiezo.toLocaleString('fr-FR')}`
              : totalPiezo.toLocaleString('fr-FR')}
          </span>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm font-semibold text-text-primary font-mono">
            {isFiltered
              ? `${filteredHydro.toLocaleString('fr-FR')} / ${totalHydro.toLocaleString('fr-FR')}`
              : totalHydro.toLocaleString('fr-FR')}
          </span>
        </div>
      </div>
    </div>
